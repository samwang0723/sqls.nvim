...
M.on_attach = function(client, bufnr)
  if vim.fn.has("nvim-0.8.0") == 1 then
    ...
    -- avoid auto formatting on other SQL and breaks the format
  ...
  api.nvim_buf_set_keymap(
    ...
    "<Cmd>set opfunc=v:lua.require'sqls.commands'.query<CR>g@",
    { silent = true }
  )
  api.nvim_buf_set_keymap(
    bufnr,
  ...
  api.nvim_buf_set_keymap(
    ...
    "<Cmd>set opfunc=v:lua.require'sqls.commands'.query_vertical<CR>g@",
    { silent = true }
  )
  api.nvim_buf_set_keymap(
    bufnr,
